...
const NewsList=Vue.component('news-list',{
    ...
    methods:{
        searchNews:function(){
            let self = this; 
            fetch('https://newsapi.org/v2/everything?q='+ self.searchTerm + '&language=en&apiKey=c7dd40af6687478abea28879abf8f393').then(function(response)
            {
                return response.json();
            }) 
            .then(function(data){
...
const Home =Vue.component('home',{
    ...
    data:function(){
        return{
            welcome:'Hello World this is dean morgan! welcome to VueJS'
        }
    }
}); 
